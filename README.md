...
## Project Structure
    ...
    ├── testwebappdff_dev_27492  # Django project configurations
...
1. Clone this repo and `cd testwebappdff_dev_27492`
...
2. Clone this repo and `cd testwebappdff_dev_27492`
